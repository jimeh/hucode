...
/**
 * Banner prepended to the mirror.
 *
 * The mirror is generated, so it carries a pointer back to its source rather than inviting an
 * edit that the drift check would immediately reject.
 */
export const GENERATED_BANNER = [
	'/*---------------------------------------------------------------------------------------------',
	' *  Generated by build/hucode/setup-ui-protocol.ts. Do not edit.',
	` *  Source: ${CANONICAL_PROTOCOL_PATH}`,
	' *--------------------------------------------------------------------------------------------*/',
	'',
	'',
].join('\n');
...
export function renderGeneratedProtocol(canonical: string): string {
	return `${GENERATED_BANNER}${canonical}`;
}
