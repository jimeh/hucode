...
const omittedFromOmniDesktop = new Map([
	...
	[
		'src/vs/workbench/contrib/chat/electron-browser/tunnelHost.contribution.js',
		'Desktop chat UI is not part of Omni.',
	],
	[
...
const addedByOmniDesktop = new Map([
	...
	[
		'src/vs/hucode/electron-browser/migration/editorMigrationCommand.contribution.js',
