...
export const HUCODE_WEB_USER_DATA_SERVICE_MACHINE_ID_KEY = 'storage.serviceMachineId';
...
export function shouldMigrateWebUserDataState(key: string, value: unknown): value is string {
	return key !== IS_NEW_KEY && key !== HUCODE_WEB_USER_DATA_SERVICE_MACHINE_ID_KEY && !key.startsWith(SECRET_STORAGE_PREFIX) && typeof value === 'string';
}
