...
export class BrowserView extends Disposable {
	...
	constructor(
		...
		public readonly hostedWebContentsId: number | undefined,
	...
	belongsToHostedWebContents(hostedWebContentsId: number): boolean {
		return this.hostedWebContentsId === hostedWebContentsId
			|| this._nativeHost.belongsToHostedWebContents(hostedWebContentsId);
	}
