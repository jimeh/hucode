...
import { IsHostedOmniWorkspaceContext, IsMainWindowFullscreenContext, IsOmniWindowContext, IsSessionsWindowContext } from '../../common/contextkeys.js';
		...
		super({
			...
			keybinding: {
				...
				when: ContextKeyExpr.and(
					...
					IsOmniWindowContext.toNegated(),
					IsHostedOmniWorkspaceContext.toNegated()
				),
				primary: KeyMod.CtrlCmd | KeyCode.KeyR
			}
		});
