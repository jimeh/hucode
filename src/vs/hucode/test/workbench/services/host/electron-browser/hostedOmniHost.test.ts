...
import { getHucodeHostedOmniScreenshot, HucodeHostedOmniFocusTracker, IHucodeHostedWorkspaceState, IHucodeShellService } from '../../../../../workbench/services/host/electron-browser/hostedOmniHost.js';
