...
export class OmniWorkspaceContextService extends Disposable implements IWorkspaceContextService, IWorkspaceEditingService {
	...
	constructor(
		...
		super();
		this.workspace = new Workspace(workspaceIdentifier.id, [], false, workspaceIdentifier.configPath, uri => uriIdentityService.extUri.ignorePathCasing(uri), localize('omniWindow', "Hucode Omni Window"));
	}
