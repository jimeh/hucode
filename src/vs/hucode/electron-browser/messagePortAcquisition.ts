...
import { ipcMessagePort, ipcRenderer } from
...
/** Acquires a MessagePort while preserving a denied result as `undefined`. */
export async function acquirePortOrUndefined(
