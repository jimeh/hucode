...
//#region --- workbench (omni desktop main)
...
import './electron-browser/onboarding/onboardingStartup.js';
...
import './browser/omniHost.contribution.js';

//#endregion


export { main } from './electron-browser/omni.main.js';
